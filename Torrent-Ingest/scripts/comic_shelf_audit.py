...
WHAT THE OWNER SEES, AND WHY NOTHING ELSE CATCHES IT
    ...
    `purge_sweeper.py` cannot help with either: it only ever removes BLOCKLISTED titles,
    which is the safety rule §4.167 was paid for, and neither of these is blocklisted.
