...
#
# 2. GOOGLE / YOUTUBE -- the YouTube ingest (~/Developer/Media-Orchestrator/YouTube-Downloader) authenticates
...
REPO_COPY="${HOME_DIR:-/nonexistent}/Developer/Media-Orchestrator/Media-Syncer/scripts/split_tunnel.sh"
SELF="${BASH_SOURCE[0]}"
